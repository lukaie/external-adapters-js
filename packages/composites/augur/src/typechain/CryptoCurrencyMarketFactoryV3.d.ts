...
interface CryptoCurrencyMarketFactoryV3Interface extends ethers.utils.Interface {
  functions: {
    ...
    'pokeCoin(uint256,uint256,uint80)': FunctionFragment
  ...
  decodeFunctionResult(functionFragment: 'pokeCoin', data: BytesLike): Result
  ...
  events: {
    ...
    'ValueUpdate(uint256,uint256,uint256,uint256)': EventFragment
...
export class CryptoCurrencyMarketFactoryV3 extends Contract {
  ...
  interface: CryptoCurrencyMarketFactoryV3Interface
  ...
  functions: {
    ...
    getMarketDetails(
      ...
      [
        [BigNumber, BigNumber, BigNumber, BigNumber] & {
          coinIndex: BigNumber
          creationValue: BigNumber
          resolutionValue: BigNumber
    ...
    'pokeCoin(uint256,uint256,uint80)'(
      _coinIndex: BigNumberish,
      _resolutionTime: BigNumberish,
      _roundId: BigNumberish,
      overrides?: Overrides & { from?: string | Promise<string> },
  ...
  filters: {
    ...
    ValueUpdate(
      coinIndex: BigNumberish | null,
      resolutionTime: BigNumberish | null,
      market: null,
      value: null,
    ): TypedEventFilter<
      [BigNumber, BigNumber, BigNumber, BigNumber],
