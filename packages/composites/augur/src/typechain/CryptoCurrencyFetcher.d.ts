...
interface CryptoCurrencyFetcherInterface extends ethers.utils.Interface {
  functions: {
...
export class CryptoCurrencyFetcher extends Contract {
  ...
  interface: CryptoCurrencyFetcherInterface
