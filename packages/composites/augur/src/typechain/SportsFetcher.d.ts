...
interface SportsFetcherInterface extends ethers.utils.Interface {
  functions: {
    ...
    "listResolvableEvents(address,uint256,uint256)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "listResolvableEvents",
...
export class SportsFetcher extends Contract {
  ...
  interface: SportsFetcherInterface;
  ...
  functions: {
    ...
    listResolvableEvents(
      ...
      [BigNumber[], BigNumber] & {
        _resolvableEvents: BigNumber[];
        _eventIndex: BigNumber;
      }
    >;

    "listResolvableEvents(address,uint256,uint256)"(
      _marketFactory: string,
      _offset: BigNumberish,
      _total: BigNumberish,
      overrides?: CallOverrides
