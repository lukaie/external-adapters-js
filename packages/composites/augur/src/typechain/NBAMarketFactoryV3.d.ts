...
interface NBAMarketFactoryV3Interface extends ethers.utils.Interface {
  functions: {
...
export class NBAMarketFactoryV3 extends Contract {
  ...
  interface: NBAMarketFactoryV3Interface
